...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
  ...
  @Autowired
  public SecurityConfig(CustomAuthenticationSuccessHandler customAuthenticationSuccessHandler, CustomOauth2Service customOauth2Service) {
  ...
  protected void configure(HttpSecurity http) throws Exception {
    ...
    http.csrf()
            ...
            .and()
            .authorizeRequests()
            .antMatchers("/**", "/login-v1/connect/*", "/login-v1/**")
            .permitAll()
            .and()
            .authorizeRequests()
            .anyRequest()
            .authenticated()
            .and().oauth2Login()            //for oauth2 login google, facebook, github
            .redirectionEndpoint()
            .baseUri("/auth/*")
            .and()
            .userInfoEndpoint()
            ...
            .and().exceptionHandling().and().addFilterBefore(ssoFilter(), BasicAuthenticationFilter.class);
  }
...
*/
    ...
    UserInfoTokenServices tokenServices = new UserInfoTokenServices(twitterResource().getUserInfoUri(), twitter().getClientId());
...
*/
  ...
  @Bean
  @ConfigurationProperties("instgram.resource")
